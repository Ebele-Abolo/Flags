# -*- coding: utf-8 -*-
"""
Created on Sat Sep 11 08:00:54 2021
...
root = Tk()
root.title("Planet and Flag Encyclopedia")
...
Indian = ImageTk.PhotoImage(Image.open("india.jpg"))
...
planets = ["Mercury", "Venus", "Earth", "india"]
...
def PlanetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_name['text'] = "Indian"
        label_planet_image['image'] = india
        label_planet_gravity_radius['text'] = "The total area covered by India is 32,87,263 sq km, out of which the land covers 29,73,190 sq km."
        label_planet_info['text'] = "India, officially the Republic of India, is a country in South Asia. It is the seventh-largest country by area, the second-most populous country, and the most populous democracy in the world."
       
dropdown.place(relx=0.5, rely = 0.3 , anchor = CENTER)        
        
btn = Button(root, text="Show Planet/Flag info" , command=PlanetInfo)
btn.place(relx=0.5, rely=0.18, anchor=CENTER)

label_planet.place(relx=0.2, rely=0.3 , anchor=CENTER)
